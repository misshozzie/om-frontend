                    ...
                    <ul className="p-3 bg-customBlue rounded-t-none">
                      <li>
                        <Link
                          to="/calendar"
                          onClick={() =>
                            navigate(`/user/calendar?username=${username}`)
                          }
                        >
                          Calendar
                        </Link>
                      ...
                      <li>
                        <Link
                          to="/Notes"
                          onClick={() =>
                            navigate(`/user/notes?username=${username}`)
                          }
                        >
                          Notes
                        </Link>
                      ...
                      <li>
                        <Link
                          to="/pdfConverter"
                          onClick={() =>
                            navigate(`/user/pdfConverter?username=${username}`)
                          }
                        >
                          Converter
                        </Link>
              ...
              {user && (
                <>
                  {user && user && user.role === "user" && (
                    <li>
                      <Link to={`/UpdateProfile/${user?.email}`}>ACCOUNT</Link>
                    </li>
                  )}
